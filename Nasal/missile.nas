...
var AcModel        = props.globals.getNode("sim/model/F-18D");
var OurHdg         = props.globals.getNode("orientation/heading-deg");
var OurRoll        = props.globals.getNode("orientation/roll-deg");
var OurPitch       = props.globals.getNode("orientation/pitch-deg");
#var HudReticleDev  = props.globals.getNode("sim/model/F-18D/instrumentation/radar-awg-9/hud/reticle-total-deviation", 1);
#var HudReticleDeg  = props.globals.getNode("sim/model/F-18D/instrumentation/radar-awg-9/hud/reticle-total-angle", 1);
...
var MISSILE = {
        ...
        del: func {
                ...
                if(me.free == 1){
                        ...
                        if (getprop("sim/model/F-18D/systems/armament/mp-messaging")=="true") {
...
var MPReport = func () {
        if (getprop("sim/model/F-18D/systems/armament/mp-messaging")=="true") {
                setprop("sim/model/F-18D/systems/armament/mp-messaging","false");
        }else{
                setprop("sim/model/m2000-5/systems/armament/mp-messaging","true");
        }
        var phrase = "MP messaging : " ~ getprop("sim/model/F-18D/systems/armament/mp-messaging");
        setprop("/sim/messages/atc", phrase);
}
